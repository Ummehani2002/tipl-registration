...
<body>
    <header class="site-header">
        <img src="<?php echo e(asset(env('LOGO_PATH', 'logo.png'))); ?>" alt="Logo" onerror="this.style.display='none'" />
        <div>
    ...
    <main class="container">
        <?php if(session('status')): ?>
            <div style="background:#e6ffed;border:1px solid #b7f0c6;padding:8px;margin-bottom:12px"><?php echo e(session('status')); ?></div>
        <?php endif; ?>
...
<?php /**PATH C:\Users\Umme Hani\tipl-registration\resources\views/layouts/app.blade.php ENDPATH**/ ?>